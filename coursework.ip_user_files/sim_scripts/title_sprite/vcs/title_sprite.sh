...
#
# Script generated by Vivado on Wed Dec 27 14:15:31 +0000 2023
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : title_sprite.sh
...
#
# Usage        : title_sprite.sh
#                title_sprite.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                title_sprite.sh [-reset_run]
#                title_sprite.sh [-reset_log]
#                title_sprite.sh [-help]
#
...
#                script (type 'title_sprite.sh -help' for more information).
#
...
# script info
echo -e "title_sprite.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./title_sprite.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.title_sprite xil_defaultlib.glbl -o title_sprite_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./title_sprite_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key title_sprite_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc title_sprite_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./title_sprite.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: title_sprite.sh [-help]\n\
Usage: title_sprite.sh [-step]\n\
Usage: title_sprite.sh [-lib_map_path]\n\
Usage: title_sprite.sh [-reset_run]\n\
Usage: title_sprite.sh [-reset_log]\n\
Usage: title_sprite.sh [-keep_index]\n\
Usage: title_sprite.sh [-noclean_files]\n\n\
