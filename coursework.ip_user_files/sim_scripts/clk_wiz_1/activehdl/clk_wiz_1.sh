...
#
# Script generated by Vivado on Sat Dec 23 22:18:16 +0000 2023
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/Joshua/Desktop/Programming/uni/es2e3/coursework/coursework.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
