...
#
# Script generated by Vivado on Wed Dec 27 14:14:01 +0000 2023
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : id_sprite.sh
...
#
# Usage        : id_sprite.sh
#                id_sprite.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                id_sprite.sh [-reset_run]
#                id_sprite.sh [-reset_log]
#                id_sprite.sh [-help]
#
...
# script info
echo -e "id_sprite.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./id_sprite.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_6 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot id_sprite xil_defaultlib.id_sprite xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim id_sprite -key {Behavioral:sim_1:Functional:id_sprite} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb id_sprite.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./id_sprite.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: id_sprite.sh [-help]\n\
Usage: id_sprite.sh [-step]\n\
Usage: id_sprite.sh [-lib_map_path]\n\
Usage: id_sprite.sh [-reset_run]\n\
Usage: id_sprite.sh [-reset_log]\n\
Usage: id_sprite.sh [-keep_index]\n\
Usage: id_sprite.sh [-noclean_files]\n\n\
