...
#                script (type 'id_sprite.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.id_sprite xil_defaultlib.glbl -o id_sprite_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./id_sprite_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key id_sprite_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc id_sprite_simv.daidir vcs_lib c.obj)
